...
# 2. チームメンバー紹介
|                                                              キム・ゴンウ                                                               |                                                             ウ・ソンジュン                                                               |                                                              イ・ヒョビン                                                                |                                                              ユ・デハン                                                               |                                                             シム・ソンファン|
| :--------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------: |
...
# 6. Commit Message コンベンション
```
# ✨ feat : 新しい機能についたコミット
# 🐛 fix : バグ修正についたコミット
# 👷 build : Build関連ファイル修正についたコミット
# 🔨 chore : その他、様々な修正についたコミット（その他変更）
# 💚 ci : CI関連設定の修正についたコミット
# 📝 docs : ドキュメント修正についたコミット
# 💄 style : ui styleについたコミット
# 🎨 refactor : コードリファクタリングについたコミット
# ✅ test : テストコードの修正についたコミット
# 🎉 init : プロジェクト開始についたコミット
# 🔖 release: リリースについたコミッt
# ➕ plus : add dependency
